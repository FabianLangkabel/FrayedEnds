...
for distance in distance_list:
    ...
    for iteration in range(12):
        ...
        if iteration==0:
            ...
            mol = tq.Molecule(parameters=params0, one_body_integrals=h1, two_body_integrals=g2, nuclear_repulsion=c, 
                              n_electrons=2)
        ...
        orbitals = opti.get_orbitals(orbitals=orbitals, rdm1=rdm1, rdm2=rdm2, maxiter=1, opt_thresh=0.00001, occ_thresh=0.00001)
        active_orbitals = []
        for i in range(len(orbitals)):
