...
for iteration in range(10):
    ...
    c, h1, g2 = integralsOS.compute_effective_hamiltonian([], [], orbitals_ab[0], orbitals_ab[1], mra_pot, nuc_repulsion)
    ...
    e, fcivec = fci.direct_uhf.kernel(
        h1, g2, n_orbitals, (n_alpha, n_beta) 
    )
    rdm1, rdm2 = fci.direct_uhf.make_rdm12s(
        fcivec, n_orbitals, (n_alpha, n_beta)
    )
    ...
    opti = fe.Optimization_open_shell(world, mra_pot, nuc_repulsion)
    core, orbitals_ab, converged = opti.optimize_orbs(
