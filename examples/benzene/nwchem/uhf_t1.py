...
scf
 ...
 direct
 thresh 1.0e-7
 vectors input rhf.mos swap alpha 22 28
end
task scf
...
# Alle alpha- und beta-Orbitale plotten (2D-Schnitt z=+1 Ang ueber Molekuelebene)
from plot_mos import plot_all_mos, find_molden_file
molden_path = find_molden_file(".")
if molden_path:
    print(f"\nPlotte Orbitale aus {molden_path} ...")
    plot_all_mos(molden_path, outdir="mo_plots_uhf_t1", z_above=1.0)
else:
