...
driver.initialize_system(n_sites=len(active_alpha_orbitals), n_elec=9, spin=1)
bond_dims = [250] * 4 + [500]
...
opti.optimize_orbs(orbitals=[[], [], active_alpha_orbitals, active_beta_orbitals], rdm1=rdm_1, rdm2=[rdm_2_phys_aa, rdm_2_phys_ab, rdm_2_phys_bb], opt_thresh=0.001, occ_thresh=0.001, maxiter=1)