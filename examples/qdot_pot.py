...
world = fe.MadWorld(ndims=3)  # This is required for any MADNESS calculation as it initializes the required environment
...
for iteration in range(6):
    ...
    opti = fe.Optimization(world, mra_pot, nuc_repulsion=0.0)
