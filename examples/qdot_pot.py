...
factory = mad.MRAFunctionFactory3D(
    world, potential
...
world.line_plot(
    "potential.dat", mra_pot, axis="z", datapoints=2001
)  # This plots the potential along the z-axis
for i in range(len(orbitals)):
    world.line_plot(
        f"es_orb{i}.dat", orbitals[i], axis="z", datapoints=2001
