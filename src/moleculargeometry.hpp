...
class MolecularGeometry {
  public:
    ...
    Function<double, 3> compute_nuclear_derivative(MadnessProcess<3>& mp, const int atom, const int axis);
    Function<double, 3> compute_second_nuclear_derivative(MadnessProcess<3>& mp, const int atom, const int axis1,
                                                          const int axis2);
    ...
    Function<double, 3> get_vnuc(MadnessProcess<3>& mp);
