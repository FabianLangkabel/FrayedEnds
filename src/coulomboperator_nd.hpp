...
// the CoulombOperatorND class is a generalization of the CoulombOperator class from madness/mra/operator.h for 1 and 2
// dimensions Applying a CoulombOperatorND<N> object to a function of the same dimension N results in the convolution of
// the function with the Coulomb kernel 1/r

using namespace madness;

template <std::size_t NDIM>
std::pair<Tensor<double>, Tensor<double>> gauss_fit_coulomb(double lo, double hi, double eps,
    ...
    // in the original implementation there is a bunch of code here which gets executed when a variable nmom is larger
    // than 0, however nmom is always set to zero in the original implementation, so I removed it
