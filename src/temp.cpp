...
std::vector<SavedFct<3>> PNOInterface::get_pnos_filtered(const std::string& type_filter) const {
...
std::vector<SavedFct<3>> PNOInterface::get_gs_orbitals() const {
...
std::vector<SavedFct<3>> PNOInterface::get_ex_orbitals() const {
